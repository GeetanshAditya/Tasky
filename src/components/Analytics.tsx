      ...
      <div className="p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-10">
            <div className="animate-slide-in">
              <div className="flex items-center space-x-4 mb-2">
                ...
                <div>
                  <h1 className="text-4xl font-bold text-white text-shadow">Analytics Dashboard</h1>
                  <p className="text-indigo-300 font-medium">Insights into your productivity journey</p>
                </div>
              </div>
            </div>
            <button
              onClick={exportData}
              className="flex items-center space-x-2 px-6 py-3 glass border border-white/20 rounded-xl transition-all duration-300 hover:scale-105 card-hover"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div className="glass rounded-xl p-6 border border-white/20 card-hover animate-fade-in">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm font-bold gradient-primary text-transparent bg-clip-text">
            ...
            <div className="glass rounded-xl p-6 border border-white/20 card-hover animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="flex items-center justify-between mb-4">
            ...
            <div className="glass rounded-xl p-6 border border-white/20 card-hover animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="flex items-center justify-between mb-4">
                <div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center">
                 
                </div>
                <div className="text-right">
                  <p className="text-3xl font-bold text-white">{analytics.efficiency.toFixed(1)}%</p>
                  <p className="text-sm text-gray-400">Efficiency</p>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div className={`text-sm font-medium ${analytics.efficiency < 100 ? 'text-green-400' : 'text-red-400'}`}>
                  {analytics.efficiency < 100 ? '🎯 Under estimate' : '⚠️ Over estimate'}
                </div>
              </div>
            </div>

            <div className="glass rounded-xl p-6 border border-white/20 card-hover animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <div className="flex items-center justify-between mb-4">
                <div className="w-12 h-12 bg-orange-500/20 rounded-xl flex items-center justify-center">
                  <Award className="w-6 h-6 text-orange-400" />
                </div>
                <div className="text-right">
                  <p className="text-3xl font-bold text-white">{analytics.thisWeekTasks}</p>
                  <p className="text-sm text-gray-400">This Week</p>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div className={`text-sm font-medium ${analytics.weeklyGrowth >= 0 ? 'text-green-400' : 'text-red-400'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
            {/* Daily Activity */}
            <div className="glass rounded-xl p-6 border border-white/20 animate-fade-in">
            ...
            <div className="glass rounded-xl p-6 border border-white/20 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                ...
                <div className="text-sm text-gray-400">{analytics.projectStats.length} projects</div>
              </div>
              <div className="space-y-4">
                {analytics.projectStats.map((project) => (
                  <div key={project.id} className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10">
                    ...
                    <div className="text-right">
                      ...
                      <div className="w-16 bg-gray-700/50 rounded-full h-2 mt-1">
                        <div 
                          className="gradient-primary h-2 rounded-full transition-all duration-500"
          ...
          <div className="glass rounded-xl p-6 border border-white/20 animate-fade-in">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm text-gray-400">Detailed breakdown</div>
            </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="text-left text-gray-400 text-sm border-b border-white/10">
                    ...
                    <th className="pb-4 font-bold">Completed</th>
                    <th className="pb-4 font-bold">Time Spent</th>
                    <th className="pb-4 font-bold">Completion Rate</th>
                ...
                <tbody className="space-y-2">
                  {analytics.projectStats.map((project) => (
                    <tr key={project.id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                      ...
                      <td className="py-4 text-gray-300 font-medium">{project.taskCount}</td>
                      <td className="py-4">
                        <div className="flex items-center space-x-2">
                          <CheckCircle2 className="w-4 h-4 text-green-400" />
                          <span className="text-green-400 font-bold">{project.completedCount}</span>
                        </div>
                      </td>
                      <td className="py-4 text-gray-300 font-medium">{formatTime(project.totalTime)}</td>
                      <td className="py-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className="text-sm font-bold text-white">{project.completionRate.toFixed(1)}%</span>
                        </div>
                      </td>
                      <td className="py-4">
